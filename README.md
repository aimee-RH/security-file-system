...
Partner 1 Name: Shuhua Zhang

Partner 1 SID: 3039657298

Partner 1 Email: sh.zhang@berkeley.edu

Partner 2 Name (if applicable): Ruihuan Gao

Partner 2 SID (if applicable): 3040857641

Partner 2 Email (if applicable): aimee0704@berkeley.edu

Also add a link to this repo below (should start with https://github.com/cs161-students/).

Link to this Github repo:https://github.com/cs161-students/sp25-proj2-aasas.git
